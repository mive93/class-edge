...
std::vector<edge::tracker_line> getTrackingLines(const tracking::Tracking& t, const cv::Mat& inv_prj_mat, const int cam_id,const float scale_x=1, const float scale_y=1, bool verbose=false);
